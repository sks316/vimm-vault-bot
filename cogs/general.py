...
class General(commands.Cog):
    ...
    async def help(self, ctx):
        ...
        embed.add_field(name="The Vault:", value="**v.lookup** - Looks for a game in The Vault and returns the results. Aliases: **v.search**\n**v.request** - Requests for a game to be added to The Vault.", inline=False)
